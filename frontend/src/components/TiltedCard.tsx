...
interface TiltedCardProps {
  ...
  children?: React.ReactNode; // Added children for custom content
}
...
export default function TiltedCard({
  ...
  imageHeight = '100%',
  imageWidth = '100%',
  scaleOnHover = 1.05, // Slightly reduced for large cards
  rotateAmplitude = 10, // Adjusted for large cards
  ...
  return (
    ...
    >
      ...
      >
        ...
        {children && (
           <motion.div className="w-full h-full will-change-transform [transform:translateZ(30px)]">
             {children}
           </motion.div>
        )}
