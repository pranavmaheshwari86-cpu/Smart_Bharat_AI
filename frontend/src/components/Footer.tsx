    ...
    <footer className="bg-surface-container-lowest border-t border-surface-container-highest relative z-10 pb-safe">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12 flex flex-col md:flex-row justify-between items-center gap-6">
        ...
        <p className="font-body-md text-xs sm:text-sm text-on-surface-variant text-center md:text-left">
          © 2026 Smart Bharat AI. An elite digital initiative.
        </p>
        <div className="flex flex-wrap items-center justify-center gap-4 sm:gap-6">
          <Link className="font-label-sm text-xs sm:text-sm text-on-surface-variant hover:text-primary transition-colors py-1.5 px-2 touch-target-min" href="/privacy">Privacy Policy</Link>
          <Link className="font-label-sm text-xs sm:text-sm text-on-surface-variant hover:text-primary transition-colors py-1.5 px-2 touch-target-min" href="/terms">Terms of Service</Link>
